<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferPersonal.aspx.cs" 
    Inherits="TransferPersonal" MasterPageFile="~/master/Master1.Master" %>
...
<%--<%@ Register TagPrefix="art" TagName="TransferPersonal" Src="~/design/BodyContainer/BC_TransferPersonal.ascx" %>--%>
...
<%--<asp:Content ID="TransferPersonalContainer" ContentPlaceHolderID="DynamicContainerContentPlaceHolder" runat="Server">
    <art:TransferPersonal ID="TransferPersonalContent" runat="server" />
</asp:Content>--%>
