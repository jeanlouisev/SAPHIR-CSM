<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoPrivilegeWarningPage.aspx.cs"
    Inherits="NoPrivilegeWarningPage" MasterPageFile="~/master/Master3.Master" %>
...
<asp:Content ID="HomeContent" ContentPlaceHolderID="DynamicContainerContentPlaceHolder" runat="Server">
    <div class="panel panel-info" runat="server" id="pnlCreateRole"> 
         <div class="panel-heading">
            <h4><span class="fa fa-exclamation-circle"></span>&nbsp;
                Attention
                </h4>
        </div>
        <div class="panel-body text-center">
           <h3>
               Désolé, vous n'avez pas les privilèges suffisants pour accéder à cette page !
           </h3>
        </div>
    </div>
</asp:Content>
