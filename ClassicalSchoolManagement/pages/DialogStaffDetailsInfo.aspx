<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DialogStaffDetailsInfo.aspx.cs" Inherits="DialogStaffDetailsInfo" %>
                        ...
                        <div class="col-sm-10">
                            <table border="0" style="width: 100%;" runat="server" id="tblInfoStaff">
                                ...
                                <tr class="trDesignMedium">
                                    ...
                                    <td></td>
                                    <td class="Style1">Role (Droit d'access)
                                    </td>
                                    <td class="Style2">
