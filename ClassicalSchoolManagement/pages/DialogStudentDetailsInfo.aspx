<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DialogStudentDetailsInfo.aspx.cs" Inherits="DialogStudentDetailsInfo" %>
        ...
        <div style="margin: auto; width: 100%; border: 0px solid red;">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h4><span class="fa fa-info-circle"></span>&nbsp;Informations Personnelles</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <table border="0" style="width: 100%;" runat="server" id="tblInfoStaff">
                                ...
                                <tr class="trDesignMedium">
                                    <td class="Style1">Vacation :
                                    </td>
                                    <td class="Style2">
                                        <asp:Label runat="server" ID="lblVacation">
                                        </asp:Label>
                                    </td>
                                    <td></td>
                                    <td class="Style1">Classe :
                                    </td>
                                    <td class="Style2">
                                        <asp:Label runat="server" ID="lblClassroom">
                                        </asp:Label>
                                    </td>
                                </tr>
                            </table>
