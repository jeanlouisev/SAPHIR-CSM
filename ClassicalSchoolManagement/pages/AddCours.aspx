<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCours.aspx.cs"
    Inherits="AddCours" MasterPageFile="~/master/Master3.Master" %>
...
<%--    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="fa fa-flag"></span>&nbsp;Ajouter cours</h4>
        </div>
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-3">
                    <asp:Label runat="server" Text="Nom cours:" CssClass="app-label-design"></asp:Label>
                ...
                <div class="col-sm-3">
                    ...
                    <button type="button" class="btn btn-primary" id="btnAdd" runat="server"
                        onserverclick="btnAddCours_Click" causesvalidation="true" style="width: 120px">
            ...
            <div class="row">
                <div class="col-md-8" style="width: 100%; overflow-x: scroll;">
                    <telerik:RadGrid runat="server" Skin="Office2007" RenderMode="Lightweight"
                        ID="gridCours"
                        OnNeedDataSource="gridCours_NeedDataSource"
                        OnItemCommand="gridCours_ItemCommand"
                        OnItemDataBound="gridCours_ItemDataBound"
                                ...
                                <telerik:GridTemplateColumn>
                                    ...
                                    <ItemTemplate>
                                        <button runat="server" class="btn btn-danger btn-sm" title="Cliquer ici pour supprimer"
                                            id="btnDelete" onserverclick="removeCourse">
                                            <span class="fa fa-remove"></span>
                                        </button>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridBoundColumn HeaderText="Nom cours" DataField="name">
                                    <HeaderStyle />
